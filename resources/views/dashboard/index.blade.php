            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                  <table class="table">
                    <thead>
                    <tr>
                      <th>#</th><th>Hashtag</th><th>Date Started</th><th>Shares Taken</th><th>Price Taken</th><th>Current Price</th><th>Change</th><th></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr ng-repeat="trade in dashboard.activeTrades">
                      <td scope="row"></td><td><a href="/hashtag/{{trade.hashtag.id}}">{{trade.hashtag.tag}}</a></td><td>{{trade.created_at}}</td><td>{{trade.shares_taken}}</td><td>{{trade.price_taken | currency}}</td><td>{{trade.hashtag.current_price | currency}}</td>
