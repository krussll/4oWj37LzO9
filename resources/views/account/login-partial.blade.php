<form ng-controller="loginController" ng-submit="login.submit()" class="form-horizontal form-label-left" ng-class="{loadingsection: login.control.isLoading}">
    <div class="item form-group" ng-class="{bad: !login.validation.email.isValid}">
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Email <span class="required">*</span>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input id="email" type="email" ng-model="login.inputs.email" type="text" class="form-control col-md-7 col-xs-12" />
        </div>
    ...
    <div class="form-group">
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
            <button type="submit" class="btn btn-success"><span ng-hide="login.control.isLoading">Submit</span><img src="/cdn/ajax-loader.gif" ng-show="login.control.isLoading" /></button>
        </div>
    </div>
</form>
