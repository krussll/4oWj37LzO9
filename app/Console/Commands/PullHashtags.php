...
class PullHashtags extends Command
{
    ...
    public function handle()
    {
        ...
        $results = DB::connection('pgsql')->select(DB::raw("SELECT LOWER(hashtag) as hashtag, COUNT(*) as count FROM  \"tagQueue\".\"tagQueue\" WHERE hashtag NOT LIKE '%?%' AND is_processed IS FALSE AND created < ':now' GROUP BY hashtag HAVING COUNT(*) > 1", 
